...
func (d *Database) RunMigrations() error {
	...
	migrations := []string{
		...
		"migrations/035_add_billing_system.up.sql",
		"migrations/036_update_plan_features.up.sql",
		"migrations/037_add_trial_plan.up.sql",
		"migrations/038_add_phone_to_users.up.sql",
	}
