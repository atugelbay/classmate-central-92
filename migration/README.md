<<<<<<< HEAD
# Миграция данных из AlfaCRM в SmartCRM

Скрипты для автоматической миграции данных из системы AlfaCRM в SmartCRM.

## 📋 Обзор

Этот модуль содержит инструменты для переноса данных из AlfaCRM (s20.online) в SmartCRM. Миграция включает всех преподавателей, студентов, группы, расписание, абонементы, транзакции и балансы.

## ⚠️ Важно

- Миграция создает данные для **одной компании** (tenant)
- Все данные изолируются по `company_id`
- Миграция создает только ближайшие 2 недели уроков (не всю историю)
- Рекомендуется делать резервную копию перед миграцией
=======
# Миграция данных из AlfaCRM

Скрипты для миграции данных из системы AlfaCRM в Classmate Central.
>>>>>>> bf4ec781af5015f11456f9bb607a4c4dc4793af2
